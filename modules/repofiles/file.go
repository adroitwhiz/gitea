...
func GetFileResponseFromCommit(repo *models.Repository, commit *git.Commit, verification *api.PayloadCommitVerification, branch, treeName string) (*api.FileResponse, error) {
